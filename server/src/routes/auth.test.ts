  ...
  describe('POST /api/auth/register', () => {
    it('should register a new user and return 201', async () => {
      ...
      (UserModel.create as jest.Mock).mockResolvedValue({
        _id: 'mockUserId', // Mock a user ID
        username: 'testuser',
        pin: 'hashedPin',
        balance: 10000, // Default initial balance from nft_config.json
        nfts: [],
      });
      ...
      expect(response.body).toEqual({
        _id: expect.any(String), // Assuming _id is generated by MongoDB
        username: 'testuser',
        pin: 'hashedPin', // This is the mocked hashed pin
        balance: expect.any(Number), // Expecting a number for balance
        nfts: [],
      });
